...
user_api_key = st.sidebar.text_input(
    label="Votre clé OpenAI API 👇",
    placeholder="Insérer votre clé ici",
    type="password")

uploaded_file = st.sidebar.file_uploader("Télecharger", type="csv")
...
if uploaded_file :
    ...
    if 'generated' not in st.session_state:
        st.session_state['generated'] = ["Hello ! Posez moi vos questions au sujet de la " + uploaded_file.name + " 🤗"]
